    ...
    <diV class="container mt-5">
        <table class="table table-striped table-hover">
            <thead class="bg-info">
                <tr>
                    <th>id</th>
                    <th>spent_grain_supplier_name</th>
                    <th>Address</th>
                    <th>contact_number</th>
                    <th>Email</th>
                    <th>spent_grain_name</th>
                    <th>quantity</th>
                    <th>Price</th>
                    <th>Delete/update</th>
                </tr>
            ...
            <tbody>
                <?php
                  foreach($detail as $demo)
                  {
                    echo "<tr>";
                    echo "<td>".$demo['id']."</td>";
                    echo "<td>".$demo['spent_grain_supplier_name']."</td>";
                    echo "<td>".$demo['Address']."</td>";
                    echo "<td>".$demo['contact_number']."</td>";
                    echo "<td>".$demo['Email']."</td>";
                    echo "<td>".$demo['spent_grain_name']."</td>";
                    echo "<td>".$demo['quantity']."</td>";
                    echo "<td>",$demo['Price']."</td>";
                    echo "<td>";
                  
                  ?>
                    <a href="delete-spent/<?= $demo['id']; ?>"><button type="button" class="btn btn-cancel" title="Delete">Delete</button></a>
                    <a href="editspent/<?= $demo['id']; ?>"><button type="button" class="btn btn-cancel" title="update">Update</button></a>
                    <?php
