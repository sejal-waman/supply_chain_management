                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                <li class="active"> <a href="login"  class=" btn-outline-success">Login</a> </li>
                                                <li> <a href="transpotation.php" style="--hover-color: green" class=" btn-outline-success">transpotation</a> </li>
                                                <li><a href="supplier.php" class=" btn-outline-success">Supplier</a></li>
                                                <li><a href="weather.php" class=" btn-outline-success">Weather</a></li>
                                                <li><a href="product.php" class=" btn-outline-success">Product</a></li>
                                                <li><a href="login.html" class=" btn-outline-success"><button class="btn btn-outline-success text-white" style="">Login/Signup</button></a></li>
            ...
            <div class="card-body p-5">
              ...
              <form action="#" method="get">
                ...
                <label class="form-label text-white" for="form3Example3cg">Your Email</label>
                  <input type="email" id="form3Example3cg" class="form-control form-control-lg bg-light" />
                </div>

                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cg">Password</label>
                  <input type="password" id="form3Example4cg" class="form-control form-control-lg bg-light" />
                </div>

                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cdg">Repeat your password</label>
                  <input type="password" id="form3Example4cdg" class="form-control form-control-lg bg-light" />
                </div>
                ...
                <div class="d-flex justify-content-center">
                  <button type="button"
                    class="btn btn-outline-dark btn-lg text-white">Register</button>
                </div>

                <p class="text-center text-white mt-5 mb-0 ">Already have an account? <a href="#!"
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12">
                        <div class="address">
                           <figure> <a href="index.html"> <img src="" alt="logo" /></a>
