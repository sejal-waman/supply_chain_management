                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                <li class="active"> <a href="company"  class=" btn-outline-success">Company</a> </li>
        ...
        <div class="col-12 col-md-9 col-lg-8 col-xl-6">
          <div class="card  bg-success" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5 text-white">BUY VEGETABLES</h2>

              <form action="<?php echo site_url('/buyvegetableinsert');?>" method="get">

                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example1cg">company_name</label>
                  <input type="text" id="form3Example1cg" class="form-control form-control-lg bg-light" name="company_name"/>
                </div>

                <div class="form-outline mb-4">
                <label class="form-label text-white" for="form3Example3cg">mobile no</label>
                  <input type="text" id="form3Example3cg" class="form-control form-control-lg bg-light" name="mobile_no"/>
                </div>
                ...
                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cg">vegetable name </label>
                  <input type="text" id="form3Example4cg" class="form-control form-control-lg bg-light"  name="vegetable_name" />
                </div>

                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cdg">quantity </label>
