                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                ...
                                                <li><a href="login" class=" btn-outline-success"><button class="btn btn-outline-success text-white" style="">Login/Signup</button></a></li>
        ...
        <div class="col-12 col-md-9 col-lg-8 col-xl-6">
          <div class="card  bg-success" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5 text-white">product details</h2>

              <form action="#" method="get">

                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example1cg">Your Name</label>
                  <input type="text" id="form3Example1cg" class="form-control form-control-lg bg-light" />
                </div>

                <div class="form-outline mb-4">
                <label class="form-label text-white" for="form3Example3cg">address</label>
                  <input type="text" id="form3Example3cg" class="form-control form-control-lg bg-light" />
                </div>

                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cg">contact number</label>
                  <input type="text" id="form3Example4cg" class="form-control form-control-lg bg-light" />
                </div>

                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cdg">product name</label>
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg bg-light" />
                </div>
                
                 <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cdg">product quantity</label>
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg bg-light" />
                </div>
                
                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cdg">product quality</label>
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg bg-light" />
                </div>
                
                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cdg">preservation</label>
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg bg-light" />
                </div>
                
                 <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cdg">price</label>
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg bg-light" />
                </div>
                ...
                <div class="d-flex justify-content-center">
                  <button type="button"
                    class="btn btn-outline-dark btn-lg text-white">submit</button>
                </div>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12">
                        <div class="address">
                           <figure> <a href="home"> <img src="" alt="logo" /></a>
