            ...
            <tbody>
                <?php
                  foreach($detail as $demo)
                  {
                    echo "<tr>";
                    echo "<td>".$demo['id']."</td>";
                    echo "<td>".$demo['grain_supplier_name']."</td>";
                  ...
                  ?>
                    <a href="delete-grain/<?= $demo['id']; ?>"><button type="button" class="btn btn-cancel" title="Delete">Delete</button></a>
                    <a href="editgrain/<?= $demo['id']; ?>"><button type="button" class="btn btn-cancel" title="update">Update</button></a>
                    <?php
