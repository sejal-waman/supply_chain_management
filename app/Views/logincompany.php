...
<body class="main-layout ">
    ...
    <header>
        ...
        <div class="header">
          ...
          <div class="card  bg-body" style="border-radius: 20px;">
                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                ...
                                                <li class="active"> 
                                                    <centre>
                                                        <a href="registrationcompany" class="btn-outline-success">Registration</a>
                                                        <a href="logincompany" class= "btn-outline-success">Login</a> </centre>
                                                </li>
        ...
        <div class="col-12 col-md-9 col-lg-8 col-xl-6">
          <div class="card  bg-success" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="<?php echo site_url('checkcompanylogin');?>" method="get"?>

               

                <div class="form-outline mb-4">
                <label class="form-label text-white" for="form3Example3cg">Your Email</label>
                  <input type="email" id="form3Example3cg" class="form-control form-control-lg bg-light" name="email" required/>
                </div>

                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cg">Password</label>
                  <input type="password" id="form3Example4cg" class="form-control form-control-lg bg-light" name="password" required/>
                </div>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-12">
                        <div class="address">
                           <figure> <a href="dashboard"> <img src="/images/logo.png" alt="logo" /></a>
