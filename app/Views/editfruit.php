...
<body>
<form method="post" action="<?= site_url('/updatefruit') ?>">
    ...
    <div class="form-group">
        ...
        <input type="text" 
        name="fruit_supplier_name" id="edit_type" 
        class="form-control"
        value="<?=$detail['fruit_supplier_name']?>" 
        required>
    </div>
    <div class="form-group">
        <label>Address</label>
    ...
    <div class="form-group">
        ...
        <input type="text" name="fruit_name" id="edit_identity_type"
         class="form-control"
         value="<?=$detail['fruit_name']?>"
          required>
    </div> 
    <div class="form-group">
