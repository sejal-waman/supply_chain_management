...
<body>
<form method="post" action="<?= site_url('/updatespent') ?>">
    <div class="modal-header">
        <h4 class="modal-title">Update spent </h4>
            </div>
 
    <div class="form-group">
        <label>spent_grain_supplier_name</label>
        <input type="text" 
        name="spent_grain_supplier_name" id="edit_type" 
        class="form-control"
        value="<?=$detail['spent_grain_supplier_name']?>" 
        required>
    </div>
    <div class="form-group">
        <label>Address</label>
        <input type="text" name="Address" id="edit_name"
         class="form-control" 
    ...
    <div class="form-group">
        <label>spent_grain_name</label>
        <input type="text" name="spent_grain_name" id="edit_identity_type"
         class="form-control"
         value="<?=$detail['spent_grain_name']?>"
          required>
    </div> 
    <div class="form-group">
        <label>quantity</label>
        <input type="text" name="quantity" id="edit_category"
         class="form-control"
    ...
    <div class="form-group">
        <label>Price</label>
        <input type="text" name="Price" id="edit_source"
         class="form-control"
         value="<?=$detail['Price']?>"
          required>
    </div>     
