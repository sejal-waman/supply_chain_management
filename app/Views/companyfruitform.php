                ...
                <div class="form-outline mb-4">
                 ...
                 <div class="form-outline mb-4">
                  ...
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg bg-light" name="quantity"/>
                    ...
                    <div class="row d-flex justify-content-center align-items-center h-4">
             <div class="col-2 col-md-12 col-lg-2 col-xl-12">
          <div class="card  bg-body" style="border-radius: 4px;">
            <div class="card-body p-1">
                ...
                <div class="row">
                    ...
                    <label class="form-label text-black" for="form3Example4cdg">---Upload Flowers Images---</label></p>
