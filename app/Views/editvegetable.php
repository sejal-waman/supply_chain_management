...
<body>
<form method="post" action="<?= site_url('/updatevegetable') ?>">
    <div class="modal-header">
        <h4 class="modal-title">Update vegetable </h4>
            </div>
 
    <div class="form-group">
        <label>vegetable_supplier_name</label>
        <input type="text" 
        name="vegetable_supplier_name" id="edit_type" 
        class="form-control"
        value="<?=$detail['vegetable_supplier_name']?>" 
        required>
    </div>
    <div class="form-group">
        <label>Address</label>
    ...
    <div class="form-group">
        ...
        <input type="text" name="vegetable_name" id="edit_identity_type"
         class="form-control"
         value="<?=$detail['vegetable_name']?>"
          required>
    </div> 
    <div class="form-group">
