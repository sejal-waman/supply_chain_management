                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                ...
                                                <li><a href="product" class=" btn-outline-success">Company/Customer</a></li>
        ...
        <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="first-slide" src="images/farmer1.jpg" alt="First slide">
                    <div class="container">
                        <div class="carousel-caption relative">
                            <h1 class="text-dark">DIGITAL FARMER</h1>
                            <span class="text-dark">Supply Chain Company</span>
                ...
                <div class="carousel-item">
                    <img class="second-slide" src="images/farmer2.jpeg" alt="Second slide">
                    <div class="container">
                        <div class="carousel-caption relative">
                            <h1 class="text-dark"></h1>
                            <span class="text-dark"></span>

                            <p class="text-dark">“Include Farmers In Digital India”  </p>
                            <a class="buynow" href="#about">About us</a>
                ...
                <div class="carousel-item">
                    <img class="third-slide" src="images/farmer3.jpeg" alt="Third slide">
                    <div class="container">
                        <div class="carousel-caption relative">
                            <h1 class="text-dark"></h1>
                            <span class="text-dark"></span>

                            <p class="text-dark">“The farmer has to be an optimist or he wouldn’t still be a farmer.” </p>
                            <a class="buynow" href="#about">About us</a>
        ...
        <div class="container">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="title">
                            <h2>Digital Farmer<strong class="black"> Store</strong></h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                            <div class="product_box">
                                <a href="#"><figure><img src="images/fruits.jpeg" alt="#" />
                                    <h3>Fruits</h3></figure></a>
                            </div>
                        </div>
                         <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                            <div class="product_box">
                                <a href="#"><figure stytle="width: 20px"><img src="images/foodgrains.jpeg" alt="#" />
                                    <h3>Food Grains</h3>
                                </figure></a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
                            <div class="product_box">
                                <a href="#"><figure><img src="images/spent_grain.jpeg" alt="#" />
                                    <h3>Spent Grain </h3></figure></a>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                            <div class="product_box">
                                <a href="#"><figure><img src="images/vegetables.jpeg" alt="#" />
                                    <h3>Vegetables</h3></figure></a>
                            </div>
                        </div>
