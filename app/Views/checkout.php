...
<head>
    ...
    <title>Digital-Farmer</title>    <meta name="keywords" content="">
	          		...
	          		<div class="cart-detail p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2">G-Pay</label>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2">Phonepe</label>
											</div>
										</div>
									</div>
									<div class="form-group">
									...
									<button onClick="alert('Order Placed Successfully')"><a href="#"class="btn btn-black py-3 px-5 bg-success btn-outline-dark">Place an order</a></button>
								</div>
	          	</div>
	          </div>
          </div> <!-- .col-md-8 -->
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-12">
                        <div class="address">
                           <figure> <a href="home.php"> <img src="images/logos.png" alt="logo" /></a>
