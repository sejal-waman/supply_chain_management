...
<body>
<form method="post" action="<?= site_url('/updateflower') ?>">
    <div class="modal-header">
        <h4 class="modal-title">Update fruit </h4>
            </div>
 
    <div class="form-group">
        <label>flower_supplier_name</label>
        <input type="text" 
        name="flower_supplier_name" id="edit_type" 
        class="form-control"
        value="<?=$detail['flower_supplier_name']?>" 
        required>
    </div>
    <div class="form-group">
        <label>Address</label>
    ...
    <div class="form-group">
        ...
        <input type="text" name="flower_name" id="edit_identity_type"
         class="form-control"
         value="<?=$detail['flower_name']?>"
          required>
    </div> 
    <div class="form-group">
