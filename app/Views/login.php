                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                ...
                                                <li class="active"> 
                                                    <centre>
                                                        <a href="registration" class="btn-outline-success">Registration</a>
                                                        <a href="login" class= "btn-outline-success">Login</a> </centre>
                                                </li>
        ...
        <div class="col-12 col-md-9 col-lg-8 col-xl-6">
          <div class="card  bg-success" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="<?php echo site_url('checksupplierlogin');?>" method="get"?>
