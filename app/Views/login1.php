                    ...
                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                ...
                                <div class="logo">
                                    <a href="login1"><img src="/images/logo.png" alt="#" ></a>
                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                ...
                                                <li class="active"> 
                                                    <centre>
                                                        <a href="login1" class= "btn-outline-success">Login</a> </centre>
                                                </li>
            ...
            <div class="card-body p-5">
              ...
              <form action="#" method="get">
                ...
                <label class="form-label text-white" for="form3Example3cg">Your Email</label>
                  <input type="email" id="form3Example3cg" class="form-control form-control-lg bg-light" name="loginid" />
                </div>
            ...
            <div class="form-check mb-0">
              ...
              <label class="form-check-label" for="form2Example3">
                ...
                <div class="d-flex justify-content-center">
                  <button type="button"
                    class="btn btn-outline-dark bg-danger btn-lg text-white" ><a href="company">Login</button>
