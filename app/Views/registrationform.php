                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                <li class="active"> 
                                                    <centre>
                                                        <a href="registration" class=" btn-outline-success">Registration</a> </centre>
                                                ...
                                                <li>
                                                    <a href="login" class=" btn-outline-success">Login </a>
              ...
              <div class="form-outline mb-4">
               ...
               <div class="form-check d-flex justify-content-center mb-5">
                ...
                <div class="d-flex justify-content-center">
                  <button type="button"
                    class="btn btn-outline-dark bg-danger btn-lg text-white">REGISTER</button>
               </div>

               
                <p class="text-center text-white mt-5 mb-0 ">alraedy have an account? <a href="login"class="fw-bold text-body text-white"><u>Login Here</u></a></p>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12">
                        <div class="address">
                           <figure> <a href="login"> <img src="images/logo.png" alt="logo" /></a>
