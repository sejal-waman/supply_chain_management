        ...
        <div class="col-12 col-md-9 col-lg-8 col-xl-6">
          <div class="card  bg-success" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5 text-white">VEGETABLES DETAILS</h2>

              <form action="<?php echo site_url('/vegetableinsert');?>" method="get">

                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example1cg">Your Name</label>
                  <input type="text" id="form3Example1cg" class="form-control form-control-lg bg-light"  name="vegetable_supplier_name" />
                </div>
                ...
                <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cdg">Vegetable Name</label>
                  <input type="text" id="form3Example4cdg" class="form-control form-control-lg bg-light" name="vegetable_name" />
                </div>
                
                 <div class="form-outline mb-4">
                    <label class="form-label text-white" for="form3Example4cdg">Quantity Of Vegetable </label>
