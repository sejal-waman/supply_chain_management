        ...
        <div class="col-12 col-md-9 col-lg-8 col-xl-6">
          <div class="card  bg-success" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="<?php echo site_url('/supplierregisterinsert');?>" method="get">


              <div class="form-outline mb-4">
                <label class="form-label text-white" for="form3Example3cg">Your Name</label>
                  <input type="text" id="form3Example3cg" class="form-control form-control-lg bg-light" name="supplier_name" />
                </div>
               ...
               <div class="form-check d-flex justify-content-center mb-5">
                ...
                <p class="text-center text-white mt-5 mb-0 ">already have an account? <a href="login"class="fw-bold text-body text-white"><u>Login Here</u></a></p>
