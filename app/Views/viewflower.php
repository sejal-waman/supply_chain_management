            ...
            <tbody>
                <?php
                  foreach($detail as $demo)
                  {
                    echo "<tr>";
                    echo "<td>".$demo['id']."</td>";
                    echo "<td>".$demo['flower_supplier_name']."</td>";
                    echo "<td>".$demo['Address']."</td>";
                    echo "<td>".$demo['contact_number']."</td>";
                    echo "<td>".$demo['Email']."</td>";
                    echo "<td>".$demo['flower_name']."</td>";
                    echo "<td>".$demo['quantity']."</td>";
                    echo "<td>",$demo['Price']."</td>";
                    echo "<td>";
                     ?>
                    <a href="delete-flower/<?= $demo['id']; ?>"><button type="button" class="btn btn-cancel" title="Delete">Delete</button></a>
                    <a href="editflower/<?= $demo['id']; ?>"><button type="button" class="btn btn-cancel" title="update">Update</button></a>
                    <?php
