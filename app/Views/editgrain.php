...
<body>
<form method="post" action="<?= site_url('/updategrain') ?>">
    <div class="modal-header">
        <h4 class="modal-title">Update grain </h4>
            </div>
 
    <div class="form-group">
        <label>fruit_supplier_name</label>
        <input type="text" 
        name="grain_supplier_name" id="edit_type" 
        class="form-control"
        value="<?=$detail['grain_supplier_name']?>" 
        required>
    </div>
    <div class="form-group">
        <label>Address</label>
    ...
    <div class="form-group">
        <label>grain_name</label>
        <input type="text" name="grain_name" id="edit_identity_type"
         class="form-control"
         value="<?=$detail['grain_name']?>"
          required>
    </div> 
    <div class="form-group">
